...
for i = 1:length(fileName)
    ...
    hold on
    %new
    p1 = plot(new_time,new_Faci,'.-','Color',colorset{1}, 'LineWidth',linewidth, 'DisplayName','Facilitation (Revised)');
    p2 = plot(new_time,new_Inhi,':','Color',colorset{1}, 'LineWidth',linewidth, 'DisplayName','Inhibition (Revised)');
    %old
    p3 = plot(old_time,old_Faci, '.-', 'Color', colorset{2}, 'LineWidth',linewidth,'DisplayName','Facilitation (Initial)');
    p4 = plot(old_time,old_Inhi, ':', 'Color', colorset{2}, 'LineWidth',linewidth,'DisplayName','Inhibition (Initial)');
    ...
    p6 = plot(time_new,old_prediction, 'LineStyle','--','Color','r',...
        'LineWidth',linewidth,'DisplayName','Simulated (Initial)');
    p7 = plot(time_new,new_prediction, 'LineStyle','-','Color','b',...
        'LineWidth',linewidth,'DisplayName','Simulated (Revised)');
...
title(h(1),'\textbf{A. iTBS600}', '\textbf{with prior contraction}',...
    'Interpreter','latex','FontSize',titilefont)
title(h(2),{'\textbf{B. imTBS600}', '\textbf{with prior contraction}'},...
    'Interpreter','latex','FontSize',titilefont)
title(h(3),{'\textbf{C. cTBS600}', '\textbf{with prior contraction}'},...
    'Interpreter','latex','FontSize',titilefont)
...
%export images
exportgraphics(gcf,'AfterEffect with prior contraction.pdf','ContentType','vector');
